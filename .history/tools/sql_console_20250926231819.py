...
def index():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            app.config['LAST_RESULT'] = (rows, cols)
...
def chart():
    ...
    rows, cols = data
    # assume stats schema: id, timestamp, cpu_usage, memory_usage
    # index: 0     1          2           3
    ...
    ax.set_title("CPU vs Memory Usage (sum over current result)")
    img = io.BytesIO()
...
if __name__ == "__main__":
    # Flask dev server; fine for lab/demo
